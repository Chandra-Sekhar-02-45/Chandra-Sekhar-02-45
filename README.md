<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=300&section=header&text=Chandra%20Sekhar&fontSize=90&animation=fadeIn&fontAlignY=38&descAlignY=51&descAlign=62" />
</div>
...
- **Founder of InnovationLink**: Creating a bridge between startups and investors.
- **Full Stack Architect**: Designing complex systems with Microservices and Event-Driven Architecture.
...
### 🚀 [InnovationLink](https://innovationlink.in)
A comprehensive startup ecosystem platform connecting entrepreneurs, investors, and mentors.
- **Role:** Founder & Lead Developer
- **Stack:** Full Stack (React, Node.js/Spring Boot)

### 🏦 Banking System
A robust, scalable banking application featuring secure transactions and portfolio management.
- **Key Tech:** Spring Boot, React, Kafka, Microservices.
- **Features:** Loan Management, Auto-Payments, Real-time Analytics.

### 🎵 Music Streaming Platform
A full-stack media streaming application with a modern UI and seamless playback.
